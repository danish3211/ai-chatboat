...
const ChatInput = ({handleInputChange, handleSubmit, input, setInput}: ChatInputProps) => {
  return (
    <div className="z-10 absolute bottom-0 left-0 bg-zinc-900 w-full">
        ...
        <div className="flex relative h-full flex-1 items-stretch md:flex-col ">
            <div className="relative flex flex-col w-full flex-grow p-4">
                <form onSubmit={handleSubmit} action="" className="relative">
                    ...
                    minRows={4} autoFocus placeholder="Enter Your Question..." className="resize-none bg-zinc-900 hover:bg-zinc-800 rounded-xl text-base"/> 
